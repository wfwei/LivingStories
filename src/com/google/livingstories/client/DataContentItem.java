...
public class DataContentItem extends BaseContentItem {
  ...
  public DataContentItem(Long id, Date timestamp, Set<Long> contributorIds, String content,
      Importance importance, Long livingStoryId) {
    super(id, timestamp, ContentItemType.DATA, contributorIds, content, importance, livingStoryId);
  }
